...
# --- NATIVE TECHNICAL INDICATORS (No pandas-ta needed) ---
...
st.dataframe(get_sector_data(), width='stretch')
st.divider()
    ...
    for ticker, info in WATCHLIST.items():
        try:
            ...
            if not df.empty and len(df) > 50:
                # Native calculations instead of pandas-ta
...
st.dataframe(get_stock_data(), width='stretch')
st.divider()
